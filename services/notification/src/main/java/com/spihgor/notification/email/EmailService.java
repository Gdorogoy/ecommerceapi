...
import com.spihgor.notification.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        mimeMessageHelper.setFrom("gdorogoy@gmail.com");
        ...
        try {
            ...
            log.info(String.format
                    ("INFO - EMAIL SUCCESSFULLY SENT TO %s VIA TEMPLATE %s, " ,destinationEmail,templateName));
